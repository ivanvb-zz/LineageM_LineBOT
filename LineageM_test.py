...
def StringSet(askString,userName,checkid):
    ...
    #else:
    #    PassStrTemp = ''
    return PassStrTemp + SplitLine + GiantStrTemp + SplitLine + sendStringTemp


print(StringSet("1106 771","test","C9b459635d139461ecbce3a368ac21542"))